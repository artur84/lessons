...
public class Color
{
     ...
     * @param redIncrement the added amount of redness
     */
    public void redden(int redIncrement)
    {
    	red = Math.min(MAX_RED, red+redIncrement);
    }
    ...
    public void turnGray()
    {
        ...
        // green - 0.7152
        // blue - 0.0722
    	int gray = (int) (0.2126 * red + 0.2126 * green + 0.2126 * blue);
    	red = gray;
    	green = gray;
    	blue = gray;
